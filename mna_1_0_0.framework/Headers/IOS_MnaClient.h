//  Copyright (c) 2021-2022 a Tencent company. All Rights Reserved.
//  mna_1_0_0.h
//  mna-1.0.0
//
...
- (void)StartListen:(NSString*)destIp maxLatency:(int)maxLatency avgLatency:(int)avgLatency onSuggestCB:(OnSuggestBlock)onSuggestCB;
